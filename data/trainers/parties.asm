...
CooltrainerMGroup:
	...
	db 50, VENOMOTH,	BRIGHTPOWDER,	STUN_SPORE, DOUBLE_TEAM, LEECH_LIFE, SLUDGE_BOMB
	db 50, GENGAR,		TWISTEDSPOON,	PSYCHIC_M, SHADOW_BALL, THUNDERBOLT, EXPLOSION
	db 50, VICTREEBEL,	MIRACLE_SEED,	GROWTH, GIGA_DRAIN, SLEEP_POWDER, SLUDGE_BOMB
	db 50, TENTACRUEL,	LEFTOVERS,	MIRROR_COAT, HYDRO_PUMP, GIGA_DRAIN, SLUDGE_BOMB
	db 50, CHARIZARD,	GOLD_BERRY,	BELLY_DRUM, FIRE_BLAST, ROCK_SLIDE, EARTHQUAKE
	db 50, KABUTOPS,	QUICK_CLAW,	SWORDS_DANCE, ANCIENTPOWER, TWINNEEDLE, DIG
	db -1 ; end

	; COOLTRAINERM (7)
	db "SIMON@", TRAINERTYPE_ITEM_MOVES
	db 55, SKARMORY,    	LEFTOVERS, 	FLY, TOXIC, STEEL_WING, SPIKES
	db 55, VICTREEBEL, 	QUICK_CLAW, 	RAZOR_LEAF, SLUDGE_BOMB, SLEEP_POWDER, LEECH_LIFE
	db 55, HOUNDOOM,    	CHARCOAL, 	CRUNCH, FLAMETHROWER, ROCK_SMASH, SUNNY_DAY
	db 55, STARMIE, 	BRIGHTPOWDER, 	PSYCHIC_M, SURF, THUNDERBOLT, ICE_BEAM
	db 55, PILOSWINE,  	SOFT_SAND,	EARTHQUAKE, ICE_BEAM, ANCIENTPOWER, CURSE
	db 50, KABUTOPS,	HARD_STONE,	SWORDS_DANCE, ROCK_SLIDE, TWINNEEDLE, ROCK_SMASH
	db -1 ; end
